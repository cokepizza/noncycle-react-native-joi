...
const internals = async() => ({
    any: null,
    date: await import('./date'),
    string: await import('./string'),
    number: await import('./number'),
    boolean: await import('./boolean'),
    alt: null,
    object: null
})();
...
exports.schema = function (config) {
    ...
    Patch.assert(config === null, 'Invalid schema content:', config);
